...
| [0090](0090-loaders-move-by-transform-from-their-first-frame-and-lyrics-read-as-verses.md) | The page-change, boot and busy loaders move by transform from their first frame, and lyrics read as verses in the MySet face | 2026-09-25 | ui | decided | founder |
...
| [0092](0092-the-instagram-dashboard-lives-on-the-site-at-media.md) | The Instagram dashboard lives on the site at /mediadash, fed by pushes from the content engine, never pulling Instagram itself | 2026-09-25 | ops | decided | claude |
...
| [0094](0094-app-css-rides-inside-every-fan-page.md) | app.css rides inside every fan page, byte for byte | 2026-09-25 | performance | decided | perry |
| [0095](0095-every-show-on-the-platform-is-filed-in-one-register-that-the-dashboard-and-the-money-model-read.md) | Every show on the platform is filed in one register that the dashboard and the money model read | 2026-09-25 | money | decided | perry-confirmed |
