...
export const PLANS = {
  free: {
    ...
    /* SHOWS PER CALENDAR MONTH (UTC — see gigMonthOf in _lib.mjs). This is the one
       ...
       under Your plan, and both refusal messages in admin.mjs. The tests read this
       number rather than repeating it, and so does MYSET-MASTER-OVERVIEW.md — its
       plan table is generated by tools/overview.mjs straight out of this object. */
    gigs: 4,
