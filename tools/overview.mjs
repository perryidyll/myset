...
*Generated from commit \`${f.stamp.stamp || f.stamp.generatedFrom}\` (${f.stamp.commitDate}) on branch \`${f.stamp.branch}\`${f.stamp.dirty ? ' — **with uncommitted changes in the tree**' : ''}.
Every number in this section is read out of the source. If one is wrong, the source is wrong.*
