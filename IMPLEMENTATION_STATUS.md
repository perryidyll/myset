...
| P3-012 | **Rate limit on casting** — token bucket on the fan record | done | 2026-09-11: `takeCastToken` in `_lib.mjs`, checked inside the vote mutation; 429 in plain words; `test/errlog.mjs` | 30 in a row, then 30 a minute. Decision `0030`, INVARIANT 0fa |
